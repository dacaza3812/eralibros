      ...
      <div className="w-full max-w-[400px]">
        ...
        <form onSubmit={handleLogin} className="bg-white rounded-[16px] p-8 space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-4 py-3 bg-[#121212] text-[#f8f8f6] text-[14px] font-[500] rounded-[8px] hover:bg-[#000000] transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
        ...
        <div className="text-center mt-6">
          <Link
            href="/"
            className="text-[14px] font-[400] text-[#d97757] hover:text-[#121212] transition-colors">
            Volver al catálogo
          </Link>
        </div>
      </div>
